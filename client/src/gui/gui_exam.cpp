...
static gboolean check_server_response(gpointer user_data) {
    ...
    if (cmd == "QUESTION") {
        ...
        if (index >= 0 && index < data->totalQuestions) {
            ...
            // Set selected answer
            if (!prevAnswer.empty()) {
                if (prevAnswer == optA) data->questions[index].selectedAnswer = "A";
                else if (prevAnswer == optB) data->questions[index].selectedAnswer = "B";
                else if (prevAnswer == optC) data->questions[index].selectedAnswer = "C";
                else if (prevAnswer == optD) data->questions[index].selectedAnswer = "D";
